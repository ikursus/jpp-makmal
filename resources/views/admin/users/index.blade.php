    ...
    <div class="page-actions" style="display: flex; gap: 8px; align-items: flex-start;">
        <div class="export-dropdown" style="position: relative; display: inline-block;">
            ...
            <div id="exportMenu" class="export-menu" style="display: none; position: absolute; right: 0; top: 100%; z-index: 1000; min-width: 260px; background: white; border: 1px solid #d1d5db; border-radius: 8px; box-shadow: 0 8px 24px rgba(0,0,0,0.15); padding: 8px 0; margin-top: 4px;">
                ...
                <a href="{{ route('admin.users.export.xlsx') }}" style="display: block; padding: 8px 16px; text-decoration: none; color: #1f2937; font-size: 14px;">📊 Excel (XLSX)</a>
                <a href="{{ route('admin.users.export.csv') }}" style="display: block; padding: 8px 16px; text-decoration: none; color: #1f2937; font-size: 14px;">📄 CSV</a>
                <a href="{{ route('admin.users.export.ods') }}" style="display: block; padding: 8px 16px; text-decoration: none; color: #1f2937; font-size: 14px;">📗 OpenDocument (ODS)</a>
                ...
                <a href="{{ route('admin.users.export.pdf') }}" style="display: block; padding: 8px 16px; text-decoration: none; color: #1f2937; font-size: 14px;">📕 PDF (DOMPDF)</a>
                <a href="{{ route('admin.users.export.tcpdf') }}" style="display: block; padding: 8px 16px; text-decoration: none; color: #1f2937; font-size: 14px;">📕 PDF (TCPDF)</a>
                <a href="{{ route('admin.users.export.mpdf') }}" style="display: block; padding: 8px 16px; text-decoration: none; color: #1f2937; font-size: 14px;">📕 PDF (MPDF)</a>
                <a href="{{ route('admin.users.export.html') }}" style="display: block; padding: 8px 16px; text-decoration: none; color: #1f2937; font-size: 14px;">🌐 HTML</a>
                <hr style="margin: 4px 0; border: 0; border-top: 1px solid #e5e7eb;">
                <div style="padding: 4px 16px; font-size: 11px; color: #6b7280; text-transform: uppercase; font-weight: 700;">Eksport Khas</div>
                <a href="{{ route('admin.users.export.view') }}" style="display: block; padding: 8px 16px; text-decoration: none; color: #1f2937; font-size: 14px;">🖼 Guna Template View</a>
                <a href="{{ route('admin.users.export.multiple-sheets') }}" style="display: block; padding: 8px 16px; text-decoration: none; color: #1f2937; font-size: 14px;">📚 Berbilang Sheet (Mengikut Daerah)</a>
                <a href="{{ route('admin.users.export.stream') }}" style="display: block; padding: 8px 16px; text-decoration: none; color: #1f2937; font-size: 14px;">🌊 Stream (Fail Besar)</a>
                <hr style="margin: 4px 0; border: 0; border-top: 1px solid #e5e7eb;">
                <div style="padding: 4px 16px; font-size: 11px; color: #6b7280; text-transform: uppercase; font-weight: 700;">Eksport ke Pelayan</div>
                <form action="{{ route('admin.users.export.store') }}" method="POST" style="padding: 4px 16px;">
                    @csrf
                ...
                <hr style="margin: 4px 0; border: 0; border-top: 1px solid #e5e7eb;">
                <form action="{{ route('admin.users.export.queue') }}" method="POST" style="padding: 4px 16px;">
                    @csrf
